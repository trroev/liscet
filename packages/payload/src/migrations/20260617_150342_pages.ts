...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "_pages_v" (
  	...
  	"version_meta_title" varchar DEFAULT 'Professional License & CEU Renewal Tracker',
  	"version_meta_description" varchar DEFAULT 'Liscet tracks your professional licenses and continuing-education credits across every state and license type, so you always know exactly how many CEUs stand between you and your next renewal.',
